...
GRANT ALL ON papyrus.* TO 'test'@'%' IDENTIFIED BY 'test';

LOAD DATA LOCAL INFILE 'entcom.csv' INTO TABLE entcom
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(NUMCOM,OBSCOM,DATCOM,NUMFOU);

LOAD DATA LOCAL INFILE 'fournis.csv' INTO TABLE fournis
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(NUMFOU,NOMFOU,RUEFOU,POSFOU,VILFOU,CONFOU,SATISF);

LOAD DATA LOCAL INFILE 'ligcom.csv' INTO TABLE ligcom
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
